...
// const {name} = pokemon.stats[0].stat
// const {base_stat} = pokemon.stats[0]
// console.log(name,base_stat)
// console.log(pokemon)

// pokemon.stats.forEach(element => {
//     console.log(pokemon)
//     const {base_stat} = element.base_stat
//     const {name} = element.base_stat.stat
//     //console.log(`nombre: ${name} Estadistica: ${base_stat}` );


    
// });

const {name} = pokemon.abilities[0].ability
console.log(name)
console.log(pokemon);

pokemon.abilities.forEach(element => {
    console.log(`Nombre: ${element.ability.name}. Url: ${element.ability.url} `)
