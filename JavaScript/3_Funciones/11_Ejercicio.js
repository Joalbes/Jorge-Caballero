...
//Funcion promedio
function promedio(promedioAcumulado,nota){
    return promedioAcumulado +  0.2 * nota
}

//Definiendo el nombre del estudiante.
...
do{
    ...
    if(isNaN(nota)  || nota < 0 || nota > 5){  
        ...
        promedioAcumulado = promedio(promedioAcumulado,nota);        
    }  
