...
for i in range(1, numeroDeProductos + 1):
    ...
    while entrar:
        ...
        if valorProducto <= 0:
            print(
                'Error: Valor invalido. El valor  del producto debe ser mayor que cero:')
        else:
            entrar = False
        ...
        if valorProducto <= 100:
            ...
            print('EL producto', i, 'tiene un descuento del 10% equivalente a:',
                  valorDescuento, 'pesos')
        elif valorProducto > 100 and valorProducto <= 200:
            valorDescuento = 0.2 * valorProducto  # Descuento del 20%
            print('EL producto', i, 'tiene un descuento del 20% equivalente a:',
                  valorDescuento, 'pesos')
        else:
            valorProducto = 0.25 * valorProducto  # Descuento del 25%
            print('EL producto', i, 'tiene un descuento del 25% equivalente a:',
                  valorDescuento, 'pesos')
