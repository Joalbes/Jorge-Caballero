...
while entrar:
    ...
    if limiteInferior < 0:
        ...
        if limiteSuperior <= limiteInferior:
            print(
                'Error: Numero no valido. Recuerde que el limite superior debe ser mayor que', limiteInferior)
        else:
            entrar = False
...
# Imprimir sumatoria
print('La sumatoria de terminos pares dentro del intervalo [',
      limiteInferior, ',', limiteSuperior, '] es: ', sumaPares)
